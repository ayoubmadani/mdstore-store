          ...
          {ls.map((p: any) => (
            <Link href={`/product/${p.id}`} key={p.id} onClick={() => setSq('')} style={{
              ...
              <div style={{ flex:1 }}>
                ...
                <div style={{ fontSize:'13px', color:'var(--sky)', fontWeight:700 }}>{p.price} DA</div>
              </div>
            </Link>
          ))}
        ...
        <div style={{
          ...
          <div className="nav-search-d" style={{ flex:1, maxWidth:350, position:'relative' }}>
            <form onSubmit={doSearch} style={{ position:'relative' }}>
              <input type="text" placeholder="Rechercher un produit santé..." value={sq} onChange={e => setSq(e.target.value)}
      ...
      {showSearch && (
        <div style={{ background:'var(--white)', borderBottom:'1px solid var(--sky)', padding:'12px 20px', position:'relative' }} className="fi">
          <form onSubmit={doSearch} style={{ position:'relative' }}>
            ...
            <Search size={16} style={{ position:'absolute', right:14, top:'50%', transform:'translateY(-50%)', color:'var(--sky)' }} />
          </form>
          {sq.length >= 2 && <SearchDrop />}
        </div>
      )}
        ...
        <div className="footer-g" style={{ paddingBottom:'36px', borderBottom:'1px solid rgba(255,255,255,0.1)' }}>
          <div>
            ...
            <div style={{ marginTop:'14px', display:'flex', alignItems:'center', gap:'8px' }}>
              ...
              <span style={{ fontSize:'12px', fontWeight:600, color:'var(--teal)' }}>Livraison rapide et sécurisée dans toutes les wilayas</span>
            </div>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h1 className="pjs" style={{
            ...
            dangerouslySetInnerHTML={{
              __html: DOMPurify.sanitize(
                store.hero?.title?.replace(/<[^>]+>/g, '').replace('Santé', '<span style="color:var(--sky)">Santé</span>')
                || 'Votre santé <span style="color:var(--sky)">en premier</span><br/>Nous sommes là pour vous aider'
              )
            }}>
          </h1>
          ...
          <div style={{
            ...
            {[
              { v:`${products.length}+`, l:'Produit de santé', c:'var(--sky)' },
              { v:'48h', l:'Livraison rapide', c:'var(--teal)' },
              { v:'100%', l:'Produits authentiques', c:'var(--green)' },
              { v:'De confiance', l:'Équipe médicale', c:'var(--sky)' },
            ].map((s, i) => (
            ...
            <div style={{ display:'flex', alignItems:'flex-end', justifyContent:'space-between', marginBottom:'32px' }}>
              <div>
                ...
                <h2 className="pjs" style={{ fontSize:'clamp(1.8rem, 4vw, 3rem)', color:'var(--ink)', lineHeight:1.1 }}>
                  Acheter par <span style={{ color:'var(--sky)' }}>La spécialité</span>
                </h2>
              </div>
            </div>
        ...
        <div style={{ maxWidth:'1280px', margin:'0 auto', padding:'0 20px' }}>
          <div style={{
            ...
            <div>
              ...
              <h2 className="pjs" style={{ fontSize:'clamp(1.8rem, 4vw, 3rem)', color:'var(--ink)', lineHeight:1.1 }}>
                Tous <span style={{ color:'var(--sky)' }}>Accessoires</span>
              </h2>
            </div>
            <p className="pjs" style={{ fontSize:'13px', fontWeight:600, color:'var(--dim)' }}>{products.length} Produit</p>
          </div>
    ...
    <div dir="ltr" style={{ background:'var(--off)' }}>
      <div style={{ maxWidth:'1280px', margin:'0 auto', padding:'32px 20px' }}>
        <div className="details-g">
            ...
            <div style={{
              ...
              {!inStock && !autoGen && (
                <div style={{ position:'absolute', inset:0, display:'flex', alignItems:'center', justifyContent:'center', background:'rgba(255,255,255,0.85)', backdropFilter:'blur(4px)' }}>
                  <span className="pjs" style={{ fontSize:'1.8rem', color:'var(--red)' }}>Non disponible</span>
                </div>
              )}
              {allImages.length > 1 && (
                <>
          ...
          <div>
            <p className="pjs" style={{ fontSize:'13px', fontWeight:700, color:'var(--sky)', marginBottom:'10px', letterSpacing:'0.08em' }}>Détails du Produit</p>
            ...
            <div style={{
              ...
              <p className="pjs" style={{ fontSize:'11px', fontWeight:700, color:'var(--sky)', marginBottom:'5px', letterSpacing:'0.08em' }}>Prix</p>
              <div style={{ display:'flex', alignItems:'baseline', gap:'10px', flexWrap:'wrap' }}>
                <span className="pjs" style={{ fontSize:'2.8rem', fontWeight:800, color:'var(--sky)', lineHeight:1 }}>
                  {finalPrice.toLocaleString()}
                </span>
                <span className="pjs" style={{ fontSize:'13px', color:'var(--dim)', fontWeight:600 }}>DA</span>
            ...
            {product.offers?.length > 0 && (
              <div style={{ marginBottom:'22px', paddingBottom:'22px', borderBottom:'1px solid var(--line)' }}>
                <p className="pjs" style={{ fontSize:'11px', fontWeight:700, color:'var(--sky)', marginBottom:'10px', letterSpacing:'0.08em' }}>Offres</p>
            ...
            {product.desc && (
              <div style={{ marginTop:'28px', paddingTop:'22px', borderTop:'1px solid var(--line)' }}>
                <p className="pjs" style={{ fontSize:'11px', fontWeight:700, color:'var(--sky)', marginBottom:'12px', letterSpacing:'0.08em' }}>Informations produit</p>
        ...
        <div>
          {product.store?.cart && (
            <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'14px' }}>
              <p className="pjs" style={{ fontSize:'11px', fontWeight:700, color:'var(--sky)', margin:0, letterSpacing:'0.08em' }}>Informations de livraison</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ border:'1px solid var(--line)', borderRadius:'10px', marginBottom:'14px', overflow:'hidden', background:'var(--white)' }}>
              <div style={{ padding:'10px 14px', borderBottom:'1px solid var(--line)', display:'flex', alignItems:'center', gap:'8px', background:'var(--sky-lt)' }}>
                ...
                <span className="pjs" style={{ fontSize:'11px', fontWeight:700, color:'var(--sky)', letterSpacing:'0.08em' }}>Résumé de la commande</span>
              </div>
              ...
              <div style={{ display:'flex', justifyContent:'space-between', alignItems:'baseline', padding:'12px 14px' }}>
                <span className="pjs" style={{ fontSize:'12px', fontWeight:700, color:'var(--dim)' }}>Total</span>
                <span className="pjs" style={{ fontSize:'1.8rem', fontWeight:800, color:'var(--sky)' }}>{total().toLocaleString()} <span style={{ fontFamily:"'Inter',sans-serif", fontWeight:400, fontSize:'12px', color:'var(--dim)' }}>DA</span></span>
              </div>
            </div>
    ...
    <div dir="ltr" style={{ minHeight:'100vh', background:'var(--off)', padding:'2.5rem 1.5rem 5rem' }}>
      <div style={{ maxWidth:1280, margin:'0 auto' }}>
        <div style={{ display:'flex', alignItems:'baseline', justifyContent:'space-between', marginBottom:'2rem', paddingBottom:'1rem', borderBottom:'2px solid var(--sky)' }}>
          ...
          <p className="pjs" style={{ fontSize:'13px', color:'var(--dim)', fontWeight:600 }}>{items.length} Produit</p>
        </div>
        <div className="cart-layout">
          <div style={{ background:'var(--white)', border:'1px solid var(--line)', borderRadius:'12px', overflow:'hidden', alignSelf:'start' }}>
              ...
              <div key={i} style={{ display:'flex', gap:'1rem', padding:'14px', borderBottom:'1px solid var(--line)' }}>
                ...
                <div style={{ flex:1, display:'flex', flexDirection:'column', justifyContent:'space-between' }}>
                  <div>
                    ...
                    <p className="pjs" style={{ fontSize:'1.2rem', fontWeight:700, color:'var(--sky)' }}>{item.finalPrice?.toLocaleString()} DA</p>
                  </div>
            ...
            <div style={{ display:'flex', justifyContent:'space-between', padding:'14px', background:'var(--slate)' }}>
              <span className="pjs" style={{ fontWeight:700, fontSize:'13px', color:'var(--dim)' }}>Sous-total</span>
              <span className="pjs" style={{ fontSize:'1.5rem', fontWeight:700, color:'var(--ink)' }}>{cartTotal.toLocaleString()} DA</span>
            </div>
          </div>

          <div style={{ background:'var(--white)', border:'1px solid var(--line)', borderRadius:'12px', padding:'22px', alignSelf:'start' }}>
            <p className="pjs" style={{ fontSize:'11px', fontWeight:700, color:'var(--sky)', marginBottom:'16px', letterSpacing:'0.08em' }}>Informations de livraison</p>
            <form onSubmit={handleSubmit}>
              <div className="form-2c">
              ...
              <div style={{ marginBottom:'14px' }}>
                <p className="pjs" style={{ fontSize:'11px', fontWeight:700, color:'var(--sky)', marginBottom:'10px', letterSpacing:'0.08em' }}>Type de livraison</p>
                <div className="dlv-2c">
                  {(['home','office'] as const).map(t=>(
                    <button key={t} type="button" onClick={()=>setFd(p=>({...p,typeLivraison:t}))} style={{
                      ...
                      <p className="pjs" style={{ fontSize:'12px', fontWeight:700, color:fd.typeLivraison===t?'var(--ink)':'var(--dim)' }}>{t==='home'?'À domicile':'Au bureau'}</p>
                      {selW && <p className="pjs" style={{ fontSize:'1rem', color:'var(--sky)', marginTop:'3px' }}>{(t==='home'?selW.livraisonHome:selW.livraisonOfice).toLocaleString()} DA</p>}
                    </button>
                  ))}
                </div>
              </div>
              ...
              <div style={{ border:'1px solid var(--line)', borderRadius:'10px', marginBottom:'14px', overflow:'hidden', background:'var(--slate)' }}>
                ...
                <div style={{ display:'flex', justifyContent:'space-between', alignItems:'baseline', padding:'12px 14px' }}>
                  <span className="pjs" style={{ fontSize:'12px', fontWeight:700, color:'var(--dim)' }}>Total</span>
                  <span className="pjs" style={{ fontSize:'1.8rem', fontWeight:800, color:'var(--sky)' }}>{finalTotal.toLocaleString()} <span style={{ fontFamily:"'Inter',sans-serif", fontWeight:400, fontSize:'12px', color:'var(--dim)' }}>DA</span></span>
                </div>
              </div>
    ...
    <div dir="ltr" style={{ background:'var(--off)', minHeight:'100vh' }}>
      <div style={{
        ...
        <div style={{ maxWidth:'960px', margin:'0 auto', position:'relative', zIndex:2, textAlign:'right' }}>
          <p className="pjs" style={{ fontSize:'13px', fontWeight:700, color:'var(--sky)', marginBottom:'10px', letterSpacing:'0.08em' }}>Contactez-nous</p>
          <h1 className="pjs" style={{ fontSize:'clamp(2.2rem, 5vw, 4rem)', color:'var(--ink)', lineHeight:1.05, marginBottom:'8px' }}>
            Contact <span style={{ color:'var(--sky)' }}>avec nous</span>
          </h1>
          <p style={{ fontSize:'14px', color:'var(--mid)' }}>Notre équipe médicale répond sous 24h</p>
        </div>
      </div>
      ...
      <div className="contact-g" style={{ maxWidth:'960px', margin:'0 auto', padding:'36px 20px 80px' }}>
        <div>
          <div style={{ background:'var(--white)', border:'1px solid var(--line)', borderRadius:'12px', padding:'22px', marginBottom:'12px', textAlign:'right' }}>
            <p className="pjs" style={{ fontSize:'11px', fontWeight:700, letterSpacing:'0.08em', color:'var(--sky)', marginBottom:'16px' }}>Informations de contact</p>
            {[
          ...
          <div style={{ background:'linear-gradient(135deg, var(--sky), var(--sky-2))', padding:'18px 20px', borderRadius:'12px', position:'relative', overflow:'hidden', textAlign:'right' }}>
            <p className="pjs" style={{ fontSize:'1.4rem', fontWeight:800, color:'white', margin:'0 0 4px' }}>Votre santé en premier.</p>
            <p className="pjs" style={{ fontSize:'1.8rem', fontWeight:800, color:'rgba(255,255,255,0.8)', margin:0, lineHeight:1 }}>Nous sommes là pour vous aider.</p>
          </div>
        </div>

        <div style={{ background:'var(--white)', border:'1px solid var(--line)', borderRadius:'12px', padding:'24px', textAlign:'right' }}>
          <p className="pjs" style={{ fontSize:'11px', fontWeight:700, letterSpacing:'0.08em', color:'var(--sky)', marginBottom:'18px' }}>Envoyer un message</p>
          {sent ? (
            <div style={{ minHeight:'200px', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', borderRadius:'8px', border:'1px solid var(--sky)', textAlign:'center', background:'var(--sky-lt)', padding:'28px' }}>
              ...
              <h3 className="pjs" style={{ fontSize:'1.5rem', color:'var(--ink)', margin:'0 0 6px' }}>Message envoyé !</h3>
            ...
            <form onSubmit={handleSubmit} style={{ display:'flex', flexDirection:'column', gap:'14px' }}>
              <div className="form-2c">
                <div>
                  <p className="pjs" style={{ fontSize:'11px', fontWeight:700, color:'var(--mid)', marginBottom:'5px' }}>Nom</p>
                  <input type="text" value={form.name} onChange={e=>setForm({...form,name:e.target.value})} required className="inp"/>
                </div>
                <div>
                  <p className="pjs" style={{ fontSize:'11px', fontWeight:700, color:'var(--mid)', marginBottom:'5px' }}>Téléphone</p>
                  <input type="tel" value={form.phone} onChange={e=>setForm({...form,phone:e.target.value})} required className="inp"/>
                </div>
              </div>
              <div>
                <p className="pjs" style={{ fontSize:'11px', fontWeight:700, color:'var(--mid)', marginBottom:'5px' }}>Email</p>
                <input type="email" value={form.email} onChange={e=>setForm({...form,email:e.target.value})} required className="inp"/>
              </div>
              <div>
                <p className="pjs" style={{ fontSize:'11px', fontWeight:700, color:'var(--mid)', marginBottom:'5px' }}>Votre message</p>
