    ...
    const Drop = () => (
        <div style={{
            ...
            {loading ? (
                    ...
                    {ls.map((p: any) => (
                        ...
                        >
                            ...
                            <div style={{ minWidth: 0, flex: 1 }}>
                                ...
                                <div style={{ fontSize: '0.75rem', color: 'var(--blue)', fontWeight: 900 }}>{p.price} DA</div>
                            </div>
                        </Link>
                    ))}
                ...
                <div style={{ padding: '1.25rem', textAlign: 'center', color: 'var(--soft)', fontSize: '0.875rem', fontWeight: 700 }}>Aucun résultat 🎯</div>
            )}
        </div>
    );
                ...
                <div className="nav-d-search" style={{ flex: 1, maxWidth: 360, position: 'relative' }}>
                    <form onSubmit={doSearch}>
                        <input type="text" placeholder="Rechercher des Produits... 🔍" value={sq} onChange={e => setSq(e.target.value)}
                            style={{ ...INP(), padding: '0.6rem 2.75rem 0.6rem 1rem', borderRadius: 10, border: '3px solid var(--border)', fontWeight: 700, transition: 'border-color 0.2s' }}
                            onFocus={e => (e.target.style.borderColor = 'var(--blue)')}
                            onBlur={e => (e.target.style.borderColor = 'var(--border)')} />
                        <Search size={16} style={{ position: 'absolute', right: 12, top: '50%', transform: 'translateY(-50%)', color: 'var(--blue)' }} />
                    </form>
                    {sq.length >= 2 && <Drop />}
                </div>
                ...
                <div className="footer-cols">
                    ...
                    <div>
                        ...
                        <p style={{ fontSize: '0.9rem', fontWeight: 600, color: 'rgba(255,255,255,0.5)', lineHeight: 1.75, maxWidth: 300 }}>
                            {store?.hero?.subtitle?.substring(0, 90) || '🎯 Jeux, modes et outils éducatifs innovants pour le développement de votre enfant.'}
                        </p>
                    ...
                    <div>
                        ...
                        <div style={{ marginTop: '1.5rem', padding: '1rem 1.25rem', borderRadius: 14, border: '2px solid var(--yellow)', background: 'rgba(255,224,0,0.08)' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.375rem' }}>
                                ...
                                <span className="font-boogaloo" style={{ fontSize: '1rem', color: '#fff' }}>Disponibles maintenant ! ⚡</span>
                            </div>
                            <p style={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.4)', fontWeight: 600 }}>Réponse en quelques heures</p>
                        </div>
                    </div>
            ...
            <div style={{ padding: '1rem', flex: 1, display: 'flex', flexDirection: 'column' }}>
                ...
                <div style={{ marginTop: 'auto' }}>
                    <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.375rem', marginBottom: '0.75rem' }}>
                        ...
                        <span style={{ fontSize: '0.72rem', fontWeight: 700, color: 'var(--soft)' }}>{store?.currency || 'DA'}</span>
        ...
        <div dir="ltr">
            ...
            <section style={{ padding: '4rem 1.5rem', maxWidth: 1280, margin: '0 auto' }}>
                <div className="feat-grid">
                    {[
                        { icon: <Shield size={22} />, color: 'var(--blue)', bg: 'var(--blue-lt)', t: '100% sécurisé', d: 'Certifié et garanti' },
                        { icon: <Truck size={22} />, color: 'var(--green)', bg: 'var(--green-lt)', t: 'Livraison rapide', d: '58 wilayas algériennes' },
                        { icon: <Zap size={22} />, color: 'var(--orange)', bg: 'var(--orange-lt)', t: 'Qualité supérieure', d: 'Jeux intelligents et innovants' },
            ...
            {cats.length > 0 && (
                <section style={{ padding: '0 1.5rem 4rem', maxWidth: 1280, margin: '0 auto' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.875rem', marginBottom: '1.75rem' }}>
                        ...
                        <h2 className="font-boogaloo" style={{ fontSize: 'clamp(1.75rem,4vw,2.5rem)', color: 'var(--text)' }}>Catégories</h2>
                    </div>
            ...
            <section id="products" style={{ padding: '0 1.5rem 6rem', maxWidth: 1280, margin: '0 auto' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.875rem', marginBottom: '2rem' }}>
                    ...
                    <h2 className="font-boogaloo" style={{ fontSize: 'clamp(1.75rem,4vw,2.5rem)', color: 'var(--text)' }}>Produits</h2>
                    ...
                    <div>
                        <div style={{ background: '#fff', borderRadius: 20, padding: '2rem', border: `3px solid ${pal.border}` }}>
                            ...
                            <div style={{ background: pal.bg, border: `3px solid ${pal.border}`, borderRadius: 16, padding: '1.125rem', marginBottom: '1.5rem' }}>
                                <p style={{ fontSize: '0.72rem', fontWeight: 900, color: pal.accent, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '0.375rem' }}>Prix</p>
                                <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.375rem' }}>
                                    <span className="font-boogaloo" style={{ fontSize: '3rem', color: pal.accent, lineHeight: 1 }}>{finalPrice.toLocaleString()}</span>
                                    <span style={{ fontWeight: 800, color: 'var(--mid)', fontSize: '1rem' }}>DA</span>
                                </div>
                            </div>
                            ...
                            {product.offers?.length > 0 && (
                                <div style={{ marginBottom: '1.5rem' }}>
                                    <p style={{ fontSize: '0.78rem', fontWeight: 900, color: pal.accent, textTransform: 'uppercase', marginBottom: '0.625rem' }}>🎁 Choisir le Forfait</p>
                                        ...
                                        <label key={o.id} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0.875rem 1rem', border: `3px solid ${selectedOffer === o.id ? pal.border : 'var(--border)'}`, borderRadius: 14, cursor: 'pointer', marginBottom: '0.5rem', background: selectedOffer === o.id ? pal.bg : 'transparent', transition: 'all 0.2s' }}>
                                            <div style={{ display: 'flex', alignItems: 'center', gap: '0.625rem' }}>
                                                ...
                                                <div>
                                                    ...
                                                    <p style={{ fontSize: '0.72rem', color: 'var(--soft)', fontWeight: 700 }}>Quantité: {o.quantity}</p>
                                                </div>
                                            </div>
                                            <span className="font-boogaloo" style={{ fontSize: '1.3rem', color: pal.accent }}>{o.price.toLocaleString()} DA</span>
                                        </label>
                                    ))}
                                </div>
                            )}
                            ...
                            {product.desc && (
                                <div style={{ marginTop: '2rem', paddingTop: '1.5rem', borderTop: `3px dashed ${pal.border}` }}>
                                    <p className="font-boogaloo" style={{ fontSize: '1.2rem', color: 'var(--text)', marginBottom: '0.875rem' }}>📖 Détails du Produit</p>
                ...
                <div className="anim-slide-up">
                    {product.store?.cart && (
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                            <p style={{ fontSize: '0.78rem', fontWeight: 900, color: 'var(--blue)', textTransform: 'uppercase', letterSpacing: '0.06em' }}>📦 Informations de livraison</p>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-row-2" style={{ marginBottom: '0.875rem' }}>
                            <FR error={errors.customerWelaya} label='Wilaya'>
                                <div style={{ position: 'relative' }}>
                                    <ChevronDown size={13} style={{ position: 'absolute', right: 12, top: '50%', transform: 'translateY(-50%)', color: 'var(--blue)', pointerEvents: 'none' }} />
                        ...
                        <div style={{ marginBottom: '0.875rem' }}>
                            <p style={{ fontSize: '0.78rem', fontWeight: 900, color: 'var(--mid)', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.5rem' }}>🚚 Type de livraison</p>
                            <div className="delivery-grid">
                                {(['home', 'office'] as const).map(t => (
                                    <button key={t} type="button" onClick={() => setFd(p => ({ ...p, typeLivraison: t }))} style={{ padding: '0.875rem', border: `3px solid ${fd.typeLivraison === t ? 'var(--blue)' : 'var(--border)'}`, borderRadius: 12, textAlign: 'center', cursor: 'pointer', background: fd.typeLivraison === t ? 'var(--blue-lt)' : '#fff', fontFamily: 'inherit', transition: 'all 0.2s' }}>
                                        ...
                                        <p style={{ fontWeight: 900, fontSize: '0.8rem', color: fd.typeLivraison === t ? 'var(--blue)' : 'var(--soft)' }}>{t === 'home' ? 'À domicile' : 'Au bureau'}</p>
                                        {selW && <p className="font-boogaloo" style={{ fontSize: '1rem', color: fd.typeLivraison === t ? 'var(--blue)' : 'var(--soft)' }}>{(t === 'home' ? selW.livraisonHome : selW.livraisonOfice).toLocaleString()} DA</p>}
                                    </button>
                                ))}
                            </div>
                        </div>
                        ...
                        {/* Qty */}
                        <div style={{ marginBottom: '0.875rem' }}>
                            <p style={{ fontSize: '0.78rem', fontWeight: 900, color: 'var(--mid)', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.5rem' }}>🔢 Quantité</p>
                        ...
                        <div className="dot-bg" style={{ background: '#fff', border: '3px solid var(--border)', borderRadius: 16, padding: '1.125rem', marginBottom: '1.25rem' }}>
                            <p style={{ fontSize: '0.72rem', fontWeight: 900, color: 'var(--blue)', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '0.875rem' }}>🧾 Résumé de la commande</p>
                            {[
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', paddingTop: '0.375rem' }}>
                                <span style={{ fontWeight: 900, fontSize: '0.9rem', color: 'var(--blue)' }}>Total</span>
                                <span className="font-boogaloo" style={{ fontSize: '2.25rem', color: 'var(--blue)' }}>{total().toLocaleString()} <span style={{ fontSize: '0.9rem', fontFamily: "'Nunito',sans-serif", fontWeight: 700 }}>DA</span></span>
                            </div>
                        </div>

                        <button type="submit" disabled={sub} className="btn-adv" style={BTN_MAIN}>
                            {sub ? <><Loader2 size={17} style={{ animation: 'spin 1s linear infinite' }} /> Traitement en cours...</> : '🎯 Confirmer la commande'}
                        </button>
                        <p style={{ textAlign: 'center', fontSize: '0.72rem', fontWeight: 700, color: 'var(--soft)', marginTop: '0.75rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 5 }}>
                            <Lock size={11} style={{ color: 'var(--blue)' }} /> Paiement Sécurisé et chiffré
                        </p>
                    </form>
                </div>
            )}
        ...
        <div dir="ltr" style={{ minHeight: '100vh', background: 'var(--bg)', padding: '2.5rem 1.5rem 5rem' }}>
            <div style={{ maxWidth: 1200, margin: '0 auto' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.875rem', marginBottom: '2rem' }}>
                    ...
                    <h1 className="font-boogaloo" style={{ fontSize: 'clamp(2rem,5vw,3rem)', color: 'var(--text)' }}>🛒 Panier</h1>
                </div>
                <div className="cart-layout">
                    ...
                    <div style={{ background: '#fff', borderRadius: 20, border: '3px solid var(--border)', overflow: 'hidden', alignSelf: 'start' }}>
                        ...
                        {items.map((item, i) => (
                            <div key={i} style={{ display: 'flex', gap: '1rem', padding: '1rem 1.25rem', borderBottom: '2px solid var(--border)' }}>
                                ...
                                <div style={{ flex: 1 }}>
                                    ...
                                    <p className="font-boogaloo" style={{ fontSize: '1.25rem', color: 'var(--blue)' }}>{item.finalPrice?.toLocaleString()} DA</p>
                        ...
                        <div style={{ padding: '1rem 1.25rem', background: 'var(--blue-lt)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <span style={{ fontWeight: 900, fontSize: '0.9rem', color: 'var(--blue)' }}>Sous-total</span>
                            <span className="font-boogaloo" style={{ fontSize: '1.625rem', color: 'var(--blue)' }}>{cartTotal.toLocaleString()} DA</span>
                        </div>
                    </div>
                    ...
                    <div style={{ background: '#fff', borderRadius: 20, border: '3px solid var(--border)', padding: '1.75rem', alignSelf: 'start' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: '1.5rem' }}>
                            ...
                            <span className="font-boogaloo" style={{ color: 'var(--blue)', fontSize: '1.1rem' }}>Informations de livraison</span>
                        </div>
                        <form onSubmit={handleSubmit}>
                            ...
                            <div style={{ margin: '1.25rem 0' }}>
                                <p className="font-boogaloo" style={{ fontSize: '0.9rem', color: 'var(--blue)', marginBottom: '0.75rem' }}>🚚 Type de livraison</p>
                                <div className="delivery-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
                                    {(['home', 'office'] as const).map(t => (
                                        ...
                                        >
                                            <span style={{ display: 'block', fontSize: '1.5rem', marginBottom: 4 }}>{t === 'home' ? '🏠' : '🏢'}</span>
                                            <p style={{ fontWeight: 900, fontSize: '0.85rem', color: 'var(--text)', marginBottom: 2 }}>{t === 'home' ? 'À domicile' : 'Au bureau'}</p>
                                            {selW && <p className="font-boogaloo" style={{ fontWeight: 800, fontSize: '1rem', color: 'var(--blue)' }}>{(t === 'home' ? selW.livraisonHome : selW.livraisonOfice).toLocaleString()} DA</p>}
                                        </button>
                                    ))}
                                </div>
                            </div>
                            ...
                            <div className="dot-bg" style={{ background: '#fff', border: '3px solid var(--border)', borderRadius: 14, padding: '1rem', marginBottom: '1rem' }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', paddingBottom: '0.5rem', marginBottom: '0.5rem', borderBottom: '2px dashed var(--border)' }}>
                                    <span style={{ fontSize: '0.875rem', fontWeight: 700, color: 'var(--soft)' }}>Sous-total</span>
                                    <span style={{ fontWeight: 900, fontSize: '0.9rem' }}>{cartTotal.toLocaleString()} DA</span>
                                </div>
                                <div style={{ display: 'flex', justifyContent: 'space-between', paddingBottom: '0.625rem', marginBottom: '0.625rem', borderBottom: '2px dashed var(--border)' }}>
                                    <span style={{ fontSize: '0.875rem', fontWeight: 700, color: 'var(--soft)' }}>Livraison</span>
                                    <span style={{ fontWeight: 900, fontSize: '0.9rem' }}>{getLiv() ? `${getLiv().toLocaleString()} DA` : '—'}</span>
                                </div>
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
                                    <span style={{ fontWeight: 900, color: 'var(--blue)' }}>Total</span>
                                    <span className="font-boogaloo" style={{ fontSize: '2rem', color: 'var(--blue)' }}>{finalTotal.toLocaleString()} <span style={{ fontSize: '0.85rem', fontFamily: "'Nunito',sans-serif", fontWeight: 700 }}>DA</span></span>
                                </div>
                            </div>
                            ...
                            <button type="submit" disabled={submitting} className="btn-adv" style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, padding: '0.9rem', borderRadius: 12, border: 'none', cursor: submitting ? 'not-allowed' : 'pointer', fontFamily: "'Nunito',sans-serif", fontWeight: 900, fontSize: '1rem', color: 'var(--dark)', background: 'var(--yellow)', boxShadow: '0 6px 24px rgba(255,224,0,0.4)', opacity: submitting ? 0.7 : 1 }}>
                                {submitting ? <><Loader2 size={17} style={{ animation: 'spin 1s linear infinite' }} /> En cours...</> : '🎯 Confirmer la commande'}
                            </button>
                        </form>
                    </div>
                </div>
    ...
    return (
        <div dir="ltr" style={{ background: 'var(--bg)', minHeight: '100vh' }}>
            <div className="dot-bg" style={{ background: 'var(--dark)', padding: '5rem 1.5rem 4rem', textAlign: 'center', position: 'relative' }}>
                ...
                <p style={{ color: 'rgba(255,255,255,0.6)', fontWeight: 700 }}>Nous sommes là pour vous aider toujours! 🚀</p>
                <Zigzag color="var(--bg)" flip={true} />
            </div>
                ...
                <div className='contact-layout'>
                    <div>
                        ...
                        <div style={{ padding: '1.25rem', borderRadius: 16, border: '3px solid var(--yellow)', background: 'var(--yellow-lt)', marginTop: '0.5rem' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.375rem' }}>
                                <span style={{ width: 8, height: 8, borderRadius: '50%', background: 'var(--green)', boxShadow: '0 0 8px var(--green)', display: 'inline-block' }} />
                                <span className="font-boogaloo" style={{ fontSize: '1rem', color: 'var(--dark)' }}>Disponibles maintenant ! ⚡</span>
                            </div>
                            <p style={{ fontSize: '0.78rem', color: 'var(--mid)', fontWeight: 700 }}>Réponse en quelques heures</p>
                        </div>
                    </div>
                    ...
                    <div style={{ background: '#fff', borderRadius: 20, border: '3px solid var(--border)', padding: '2rem' }}>
                        {sent ? (
                            <div style={{ textAlign: 'center', padding: '3rem' }} className="anim-zoom-in">
                                <span style={{ fontSize: '4rem', display: 'block', marginBottom: '1rem', animation: 'bounce-up 2s ease-in-out infinite' }}>🎉</span>
                                <h2 className="font-boogaloo" style={{ fontSize: '1.75rem', color: 'var(--blue)', marginBottom: '0.5rem' }}>Envoyé !</h2>
                                <p style={{ color: 'var(--mid)', fontWeight: 700, lineHeight: 1.7 }}>Nous vous répondrons au plus vite ! 🚀</p>
                            </div>
                        ) : (
                            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '0.875rem' }}>
                                ...
                                <div><label style={{ display: 'block', fontSize: '0.78rem', fontWeight: 900, color: 'var(--mid)', marginBottom: '0.35rem', textTransform: 'uppercase' }}>Votre message</label><textarea value={form.message} onChange={e => setForm({ ...form, message: e.target.value })} required rows={5} style={{ ...INP(), resize: 'none' }} /></div>
                                <button type="submit" disabled={loading} className="btn-adv" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, padding: '0.9rem', borderRadius: 12, border: 'none', cursor: loading ? 'not-allowed' : 'pointer', fontFamily: "'Nunito',sans-serif", fontWeight: 900, fontSize: '1rem', color: 'var(--dark)', background: 'var(--yellow)', boxShadow: '0 6px 24px rgba(255,224,0,0.4)', opacity: loading ? 0.7 : 1 }}>
                                    {loading ? <><Loader2 size={17} style={{ animation: 'spin 1s linear infinite' }} /> En cours...</> : <>🚀 Envoyer le message</>}
                                </button>
                            </form>
                        )}
                    </div>
