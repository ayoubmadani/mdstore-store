...
const CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; -webkit-font-smoothing: antialiased; }
  ...
  :root {
    /* Core dark blue shades (unchanged) */
    --navy:     #0D1B2A;
    --navy-2:   #162436;
    --navy-3:   #1E3048;

    /* Converting orange shades to vivid blue */
    --blue:     #3A86FF; /* New primary color — replaces orange */
    --blue-2:   #0056D2; /* Darker shade for interactions — replaces orange-2 */
    --blue-3:   #7EB1FF; /* Lighter shade for highlights — replaces orange-3 */
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                        ...
                        <p style={{ fontSize: '13px', lineHeight: '1.8', color: 'rgba(255,255,255,0.4)', maxWidth: '280px', fontWeight: 300, margin: 0 }}>
                            {store.description || 'A high-performance multipurpose theme providing a complete tech shopping experience for all product types.'}
                        </p>
                    ...
                    <div>
                        <p className="bc" style={{ fontSize: '14px', fontWeight: 700, letterSpacing: '0.1em', color: 'var(--blue)', marginBottom: '24px', textTransform: 'uppercase' }}>Quick Links</p>
                    ...
                    <div>
                        <p className="bc" style={{ fontSize: '14px', fontWeight: 700, letterSpacing: '0.1em', color: 'var(--blue)', marginBottom: '24px', textTransform: 'uppercase' }}>Contact Us</p>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                            {[
                                { icon: '📞', val: store.phone || '+213 550 000 000' },
                                { icon: '✉️', val: store.email || 'info@store.dz' },
                                { icon: '📍', val: store.address || 'Algiers' },
                            ].map((item, idx) => (
            ...
            <div style={{ padding: '14px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '6px', marginBottom: '10px' }}>
                    <div style={{ display: 'flex', alignItems: 'baseline', gap: '6px' }}>
                        ...
                        <span style={{ fontSize: '11px', color: 'var(--dim)' }}>DZD</span>
...
export function Home({ store }: any) {
    ...
    const features = [
        { icon: <Cpu style={{ width: '22px', height: '22px' }} />, label: 'High Performance' },
        { icon: <Wifi style={{ width: '22px', height: '22px' }} />, label: 'Advanced Technology' },
        { icon: <Battery style={{ width: '22px', height: '22px' }} />, label: 'Long Service Life' },
        { icon: <Layers style={{ width: '22px', height: '22px' }} />, label: 'Multi-Layer Design' },
    ];
        ...
        <div dir="ltr">
            ...
            <section className="hero-g" style={{
                ...
                <div style={{
                    ...
                    {store.hero?.imageUrl ? (
                        <>
                            ...
                            />
                            {/* Overlay[Arabic]:[Arabic]([Arabic])[Arabic] */}
                            <div style={{
                                position: 'absolute',
                                top: 0, left: 0, right: 0, bottom: 0,
                ...
                <div style={{
                    ...
                    {/* [Arabic]Store[Arabic]Badge[Arabic] */}
                    ...
                    <h1 className="fu fu-2 bc" style={{
                        ...
                        {store.hero?.title || <>Designed for Excellence.<br />Total Performance.</>}
                    </h1>
                    ...
                    <p className="fu fu-3" style={{
                        ...
                        {store.hero?.subtitle || `Discover our curated selection at ${store.name} from the Latest Tech Products.`}
                    </p>
                    ...
                    <div className="fu fu-3" style={{
                        ...
                        {[
                            { n: `${products.length}+`, l: 'Product Available' },
                            { n: 'FAST', l: 'Fast Delivery' },
            ...
            <div style={{ backgroundColor: 'var(--navy)', borderBottom: '3px solid var(--blue)' }}>
                <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
                    <div className="trust-bar">
                        {[
                            { icon: <Truck style={{ width: '20px', height: '20px' }} />, title: 'Fast Delivery', desc: '48 Hours Across Algeria' },
                            ...
                            { icon: <Zap style={{ width: '20px', height: '20px' }} />, title: 'Fast Support', desc: 'Reply within 24 Hours' },
                        ].map((item, i) => (
                ...
                <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 6vw' }}>
                    ...
                    <div style={{ marginBottom: '40px', textAlign: 'center' }}>
                        ...
                        <h2 className="fu bc" style={{ fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', fontWeight: 800, color: 'var(--navy)', margin: 0 }}>
                            Featured <span style={{ color: 'var(--blue)' }}>Categories</span>
                        </h2>
                    </div>
            ...
            <section id="products" style={{
                backgroundColor: '#F9FAFB', // clean white background
                paddingTop: '40px',
                paddingBottom: '80px'
            }}>
                    ...
                    <div style={{
                        ...
                        <div>
                            <h2 className="bc" style={{
                                ...
                                Available <span style={{ color: 'var(--blue)' }}>Products</span>
                            </h2>
                ...
                <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 24px' }}>
                    {filtered.length === 0 ? (
                        <div style={{
                            ...
                            <p className="bc" style={{ fontSize: '1.2rem', color: 'var(--dim)' }}>We're working on adding new products...</p>
                        </div>
                    ) : (
                        <div className="prod-grid" style={{
                            display: 'grid',
                            backgroundColor: '#F9FAFB',
                            // wide gaps to enhance clean appearance
                            gap: '10px',
        ...
        <div dir="ltr" style={{ backgroundColor: 'var(--off)' }}>
            ...
            <div className="details-g" style={{ maxWidth: '1280px', margin: '0 auto' }}>
                    ...
                    <div style={{ position: 'relative', aspectRatio: '1/1', overflow: 'hidden', backgroundColor: 'var(--white)', border: '1px solid var(--line)' }}>
                        ...
                        {!inStock && !autoGen && (
                            <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(248,250,252,0.88)', backdropFilter: 'blur(4px)' }}>
                                <span className="bc" style={{ fontSize: '1.5rem', fontWeight: 800, letterSpacing: '0.08em', color: 'var(--mid)' }}>Out of Stock</span>
                            </div>
                        )}
                    </div>
                    {allImages.length > 1 && (
                ...
                <div className="details-R">
                    <p className="bc" style={{ fontSize: '11px', fontWeight: 700, letterSpacing: '0.22em', color: 'var(--blue)', marginBottom: '10px' }}>// Product Details</p>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '22px', paddingBottom: '22px', borderBottom: '1px solid var(--line)', flexWrap: 'wrap' }}>
                        ...
                        <span style={{ fontSize: '12px', color: 'var(--dim)' }}>128 Rating</span>
                    ...
                    <div style={{ marginBottom: '22px', padding: '16px 18px', backgroundColor: 'var(--off)', border: '1px solid var(--line)' }}>
                        <p className="bc" style={{ fontSize: '11px', fontWeight: 700, letterSpacing: '0.2em', color: 'var(--mid)', margin: '0 0 6px' }}>Price</p>
                    ...
                    {product.offers?.length > 0 && (
                        <div style={{ marginBottom: '22px', paddingBottom: '22px', borderBottom: '1px solid var(--line)' }}>
                            <p className="bc" style={{ fontSize: '13px', fontWeight: 700, letterSpacing: '0.14em', color: 'var(--mid)', marginBottom: '10px' }}>// Packages</p>
                            {product.offers.map((offer: any) => (
                                <label key={offer.id} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 14px', border: `1.5px solid ${selectedOffer === offer.id ? 'var(--blue)' : 'var(--line)'}`, cursor: 'pointer', marginBottom: '8px', transition: 'all 0.2s', backgroundColor: selectedOffer === offer.id ? 'rgba(240,120,32,0.05)' : 'var(--white)' }}>
                                    ...
                                    <span style={{ fontSize: '1.1rem', fontWeight: 700, color: 'var(--blue)' }}>{offer.price.toLocaleString()} <span style={{ fontSize: '11px', fontWeight: 400, color: 'var(--dim)' }}>DZD</span></span>
                                </label>
                            ))}
                        </div>
                    )}
                    ...
                    {product.desc && (
                        <div style={{ marginTop: '28px', paddingTop: '22px', borderTop: '1px solid var(--line)' }}>
                            <p className="bc" style={{ fontSize: '12px', fontWeight: 700, letterSpacing: '0.16em', color: 'var(--mid)', marginBottom: '12px' }}>// Product Description</p>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div style={{ border: '1px solid var(--line)', marginBottom: '14px', overflow: 'hidden' }}>
                    <div style={{ padding: '10px 14px', backgroundColor: 'var(--navy)', display: 'flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        <span className="bc" style={{ fontSize: '13px', fontWeight: 700, letterSpacing: '0.14em', color: 'rgba(255,255,255,0.7)' }}>Order Summary</span>
                    </div>
                    {[
...
export function Terms() {
    return (
        <Shell title="Terms" sub="// Legal">
            ...
            <IB title="Prohibited Use" body="Authentic products only. No counterfeits." tag="Strict" />
        ...
        <div dir="ltr" style={{ backgroundColor: 'var(--off)', minHeight: '100vh' }}>
            <div style={{ backgroundColor: 'var(--navy)', padding: '64px 24px 48px', borderBottom: '3px solid var(--blue)', position: 'relative', overflow: 'hidden' }}>
                ...
                <div style={{ maxWidth: '960px', margin: '0 auto', position: 'relative', zIndex: 2 }}>
                    ...
                    <p className="bc" style={{ fontSize: '14px', fontWeight: 600, letterSpacing: '0.14em', color: 'rgba(255,255,255,0.4)' }}>We Reply within 24 Hours</p>
                </div>
            </div>
            ...
            <div className="contact-g" style={{ maxWidth: '960px', margin: '0 auto', padding: '40px 24px 80px' }}>
                ...
                <div>
                    <div style={{ backgroundColor: 'var(--white)', border: '1px solid var(--line)', padding: '24px', marginBottom: '12px' }}>
                        <p className="bc" style={{ fontSize: '13px', fontWeight: 700, letterSpacing: '0.16em', color: 'var(--blue)', marginBottom: '18px' }}>// Contact Methods</p>
                        {[
                    ...
                    <div style={{ backgroundColor: 'var(--navy)', padding: '20px 22px' }}>
                        <p className="bc" style={{ fontSize: '14px', fontWeight: 800, letterSpacing: '0.08em', color: 'white', lineHeight: 1.4, margin: '0 0 6px' }}>
                            Unlimited Performance.<br /><span style={{ color: 'var(--blue)' }}>Gear Up.</span>
                        </p>
                ...
                <div style={{ backgroundColor: 'var(--white)', border: '1px solid var(--line)', padding: '28px' }}>
                    <p className="bc" style={{ fontSize: '13px', fontWeight: 700, letterSpacing: '0.16em', color: 'var(--blue)', marginBottom: '22px' }}>// Send Message</p>
                    {sent ? (
                        <div style={{ minHeight: '220px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', border: '1px solid var(--line)', textAlign: 'center', backgroundColor: 'var(--off)', padding: '32px' }}>
                            ...
                            <h3 className="bc" style={{ fontSize: '1.6rem', fontWeight: 800, letterSpacing: '0.08em', color: 'var(--navy)', margin: '0 0 8px' }}>Sent!</h3>
                            <p style={{ fontSize: '13px', color: 'var(--mid)' }}>We'll reply within 24 hours.</p>
                        </div>
                    ) : (
                        <form onSubmit={e => { e.preventDefault(); setSent(true); }} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                            ...
                            <div>
                                <p className="bc" style={{ fontSize: '12px', fontWeight: 700, letterSpacing: '0.16em', color: 'var(--mid)', marginBottom: '6px' }}>Your Message</p>
                            ...
                            <button type="submit" className="btn-orange" style={{ justifyContent: 'center', width: '100%', fontSize: '15px', padding: '13px', letterSpacing: '0.12em' }}>
                                Send <ArrowRight style={{ width: '14px', height: '14px' }} />
                            </button>
                        </form>
                    )}
                </div>
