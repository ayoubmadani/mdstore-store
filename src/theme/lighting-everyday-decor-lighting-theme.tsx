...
import {
  ...
  Lightbulb, Star, Check, AlertCircle, Truck, ShieldCheck, CreditCard, Headphones, Package,
} from 'lucide-react';
...
export function ProductForm({ product, userId, domain, store: storeprop, selectedOffer, setSelectedOffer, selectedVariants, platform }: any) {
  ...
  const summaryRows = [
    ...
    { l: t.qty, v: `× ${qty}` },
    { l: t.delivery, v: !selW ? '—' : orderFreeShipping ? t.freeShippingBadge : `${fmt(getLiv())} ${cur(store)}` },
  ];
