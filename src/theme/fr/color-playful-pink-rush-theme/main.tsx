      ...
      {loading ? <div style={{ padding: '1rem', textAlign: 'center', color: '#F472B6', fontSize: '0.85rem' }}>Recherche en cours...</div>
        : listSearch.length > 0 ? (
          <div style={{ maxHeight: '320px', overflowY: 'auto' }}>
            ...
            {/* زر Voir plus انسيابي داخل القائمة */}
          ...
          <div style={{ padding: '0.375rem 1.25rem 0.875rem' }}>
            {[{ h: '/', l: 'Accueil' }, { h: '/contact', l: 'Contactez-nous' }].map(i => (
              <Link key={i.h} href={i.h} onClick={() => setOpen(false)} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0.75rem 0', borderBottom: '1px solid #F0F0F0', fontSize: '0.9rem', fontWeight: 600, color: '#111', textDecoration: 'none' }}>
                {i.l} <ArrowLeft size={14} style={{ color: '#F472B6' }} />
              </Link>
            ))}
  ...
  return (
    <div dir="ltr">
      ...
      <section style={{ position: 'relative', background: '#111', overflow: 'hidden' }}>
        ...
        {/* Geometric accent - تم تعديل التدرج للوردي */}
        ...
        {/* Circle accent - تم تعديل لون الدائرة الشفافة */}
        ...
        <div className="hero-inner" style={{ maxWidth: 1280, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          {/* Text */}
          <div>
            {/* Badge - تم تعديل الخلفية والحدود */}
...
export function Details({ product, discount, allImages, allAttrs, finalPrice, selectedVariants, setSelectedOffer, selectedOffer, handleVariantSelection, domain }: any) {
  ...
  // مراقبة حجم الشاشة للتحكم في الـ Sticky بشكل Sécurisé
  useEffect(() => {
    const handleResize = () => setIsDesktop(window.innerWidth > 768);
    handleResize(); // اpour faire fonctionner عند التحميل
      ...
      <div className="details-inner" style={{ maxWidth: 1280, margin: '0 auto' }}>
        ...
        <div>
          <div style={{ background: '#fff', borderRadius: 14, padding: isDesktop ? '1.75rem' : '1.25rem', border: '1.5px solid #E8E8E8' }}>
            ...
            {/* صندوق Prix باللون الوردي الNouveau */}
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                  {attr.variants.map((v: any) => {
                    ...
                    return (
                      ...
                      >
                        {/* يظهر النص uniquement في حالة المقاسات أو الخيارات النصية */}
      ...
      {product.store.cart && (
        <div className="cart-add-btns" style={{ marginBottom: '1.25rem' }}>
          ...
          <button
            ...
            onMouseEnter={e => ((e.currentTarget as HTMLButtonElement).style.background = '#DB2777')} // درجة وردي أعمق عند التحويم
