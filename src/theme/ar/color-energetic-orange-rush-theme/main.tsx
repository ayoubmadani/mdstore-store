...
export function Navbar({ store, domain }: { store: any; domain: string }) {
  ...
  // --- التنسيقات المدمجة داخل الـ Component ---
  ...
  const DropResults = () => (
    <div style={{
      ...
      {loading ? (
        <div style={{ padding: '1rem', textAlign: 'center', color: '#F97316', fontSize: '0.85rem' }}>جاري البحث...</div>
        ...
        <div style={{ maxHeight: '350px', overflowY: 'auto' }}>
          ...
          {/* زر عرض المزيد - يظهر في نهاية القائمة وليس ثابتاً */}
          <button
        ...
        <div className="hero-inner" style={{ maxWidth: 1280, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <div>
            ...
            <h1 style={{ fontSize: 'clamp(2.25rem,6vw,4.5rem)', fontWeight: 800, color: '#fff', lineHeight: 1.1, letterSpacing: '-0.03em', marginBottom: '1.25rem' }}
              dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(store.hero?.title || 'تسوق<br/><span style="color:#F97316">بثقة</span> واحصل<br/>على الأفضل') }} />
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                  {attr.variants.map((v: any) => {
                    ...
                    return (
                      ...
                      >
                        {/* النص يظهر فقط إذا لم يكن العرض لوناً أو صورة */}
              ...
              <div className="delivery-grid">
                {(['home', 'office'] as const).map(t => (
                  ...
                  >
                    ...
                    <p style={{ fontWeight: 700, fontSize: '0.78rem', color: fd.typeLivraison === t ? '#F97316' : '#888' }}>{t === 'home' ? 'للبيت' : 'للمكتب'}</p>
