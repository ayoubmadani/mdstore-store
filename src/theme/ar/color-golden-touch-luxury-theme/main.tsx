...
const THEME_CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* حاوية المعرض */
  .gallery-container {
    position: relative; /* الوضع الطبيعي في الجوال */
    top: 0;
    width: 100%;
  }
  ...
  @media (min-width: 768px) {
    ...
    .gallery-container {
      position: sticky; /* التثبيت فقط في الديسكطوب */
      top: 100px;
      z-index: 10;
    }
  }

  /* تحسين صندوق المعلومات للجوال */
  .info-container {
    background: #fff; 
    border-radius: 14px; 
        ...
        <div>
          <div className="info-container">
            ...
            <div style={{ background: '#000', border: '1px solid #D4AF37', borderRadius: 12, padding: '1rem 1.25rem', marginBottom: '1.5rem', boxShadow: '0 4px 15px rgba(212, 175, 55, 0.1)' }}>
              <p style={{ fontSize: '0.75rem', color: '#D4AF37', fontWeight: 700, marginBottom: '0.25rem', textTransform: 'uppercase' }}>السعر الإجمالي</p>
                  ...
                  {attr.variants.map((v: any) => (
                    <button
                      ...
                      style={attr.displayMode === 'color' ? {
                        ...
                        outline: `2.5px solid ${selectedVariants[attr.name] === v.value ? '#D4AF37' : 'transparent'}`, outlineOffset: 2
                      } : {
                        padding: '0.5rem 1rem', border: `1.5px solid ${selectedVariants[attr.name] === v.value ? '#D4AF37' : '#E8E8E8'}`,
                        borderRadius: 8, fontSize: '0.85rem', fontWeight: 600, background: selectedVariants[attr.name] === v.value ? 'rgba(212, 175, 55, 0.05)' : '#fff',
                        color: selectedVariants[attr.name] === v.value ? '#D4AF37' : '#555', cursor: 'pointer'
                      }}
                    >
