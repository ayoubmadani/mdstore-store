...
const T = {
  ar: {
    dir: 'rtl' as const,
    home: 'الرئيسية', contact: 'اتصل بنا', cart: 'السلة', menuLabel: 'القائمة',
    search: 'ابحث عن منتج...', searching: 'جاري البحث...', noResults: 'لا توجد نتائج', showAll: 'عرض كل النتائج →',
    all: 'الكل', noProducts: 'لا توجد منتجات حالياً.', shopNow: 'تسوق الآن', cartBtn: 'سلة المشتريات',
    searchResultsFor: 'نتائج البحث عن:',
    fullName: 'الاسم الكامل', fullNamePh: 'الاسم الكامل', errName: 'الاسم مطلوب',
    phone: 'رقم الهاتف', phonePh: '0555 xx xx xx', errPhone: 'رقم الهاتف مطلوب', errPhoneInvalid: 'رقم هاتف غير صحيح',
    wilaya: 'الولاية', errWilaya: 'اختر الولاية', wilayaPh: 'اختر الولاية', wilayaNA: 'التوصيل غير متاح حالياً',
    commune: 'البلدية', errCommune: 'اختر البلدية', communePh: 'اختر البلدية', communeLoading: 'جاري التحميل...',
    deliveryType: 'نوع التوصيل', deliveryHome: 'توصيل للمنزل', deliveryOffice: 'توصيل للمكتب',
    qty: 'الكمية', price: 'السعر', delivery: 'التوصيل', total: 'الإجمالي', subtotal: 'المجموع',
    orderInfo: 'معلومات التوصيل', addToCart: 'أضف إلى السلة', addedMsg: 'تمت الإضافة ✓',
    orderNow: 'اطلب الآن', confirmOrder: 'تأكيد الطلب', sending: 'جاري الإرسال...', back: 'إلغاء',
    errSubmit: 'حدث خطأ أثناء إرسال الطلب', stockLabel: 'متوفر',
    myCart: 'سلة المشتريات', cartEmpty: 'سلتك فارغة', cartEmptyDesc: 'لم تقم بإضافة أي منتجات بعد',
    ...
    trust: [
      ...
      { t: 'دفع آمن', s: 'عند الاستلام' },
      { t: 'منتجات أصلية', s: 'ضمان الجودة' },
      { t: 'دعم فني', s: 'على مدار اليوم' },
    ],
    privacyTitle: 'سياسة الخصوصية',
    privacySections: [
      { title: 'جمع المعلومات', body: 'نقوم بجمع المعلومات الضرورية فقط لإتمام عملية الطلب والتوصيل، مثل الاسم ورقم الهاتف والعنوان.' },
      { title: 'استخدام المعلومات', body: 'تُستخدم بياناتك حصراً لمعالجة طلباتك والتواصل معك بخصوصها، ولا تتم مشاركتها مع أي جهة خارجية دون موافقتك.' },
      { title: 'حماية البيانات', body: 'نتخذ الإجراءات التقنية اللازمة لحماية بياناتك من أي وصول أو استخدام غير مصرح به.' },
    ],
    termsTitle: 'الشروط والأحكام',
    termsSections: [
      { title: 'الطلبات', body: 'يتم تأكيد الطلب بعد التواصل مع العميل، ويحتفظ المتجر بحق إلغاء أي طلب غير مكتمل البيانات.' },
      { title: 'الأسعار', body: 'جميع الأسعار المعروضة تشمل العملة المحلية وقد تتغير دون إشعار مسبق.' },
      { title: 'التوصيل', body: 'مدة التوصيل تختلف حسب الولاية، وتُحتسب رسوم التوصيل بشكل منفصل عن سعر المنتج.' },
    ],
    cookiesTitle: 'سياسة الكوكيز',
    cookiesSections: [
      { title: 'ما هي الكوكيز', body: 'ملفات صغيرة تُخزَّن في متصفحك لتحسين تجربة التصفح وتذكر محتوى سلة مشترياتك.' },
      { title: 'استخدامنا للكوكيز', body: 'نستخدم الكوكيز فقط لأغراض تشغيلية أساسية مثل حفظ محتوى السلة، دون تتبع إعلاني.' },
      { title: 'التحكم', body: 'يمكنك تعطيل الكوكيز من إعدادات متصفحك، مع العلم أن ذلك قد يؤثر على بعض وظائف المتجر.' },
    ],
    contactTitle: 'تواصل معنا', contactName: 'الاسم', contactEmail: 'البريد الإلكتروني',
    contactPhone: 'الهاتف', contactMessage: 'الرسالة', contactSend: 'إرسال',
    contactSending: 'جاري الإرسال...', contactSent: 'تم إرسال رسالتك ✓',
    contactSentDesc: 'سنتواصل معك في أقرب وقت.', contactSendAnother: 'إرسال رسالة أخرى',
  },
  fr: {
    dir: 'ltr' as const,
    home: 'Accueil', contact: 'Contact', cart: 'Panier', menuLabel: 'Menu',
    search: 'Rechercher un produit...', searching: 'Recherche...', noResults: 'Aucun résultat', showAll: 'Voir tous les résultats →',
    all: 'Tout', noProducts: 'Aucun produit disponible pour le moment.', shopNow: 'Voir la boutique', cartBtn: 'Mon Panier',
    searchResultsFor: 'Résultats pour :',
    fullName: 'Nom complet', fullNamePh: 'Votre nom', errName: 'Le nom est requis',
    phone: 'Téléphone', phonePh: '0555 xx xx xx', errPhone: 'Le numéro de téléphone est requis', errPhoneInvalid: 'Numéro de téléphone invalide',
    ...
    orderInfo: 'Informations de livraison', addToCart: 'Ajouter au panier', addedMsg: 'Ajouté au panier ✓',
    orderNow: 'Commander maintenant', confirmOrder: 'Confirmer la commande', sending: 'Envoi en cours...', back: 'Annuler',
    errSubmit: 'Une erreur est survenue, veuillez réessayer.', stockLabel: 'En stock',
    ...
    trust: [
      ...
      { t: 'Paiement sécurisé', s: 'À la livraison' },
      { t: 'Produits certifiés', s: 'Qualité garantie' },
      { t: 'Support technique', s: 'Disponible 24h/24' },
    ],
    privacyTitle: 'Politique de confidentialité',
    privacySections: [
      { title: 'Collecte des données', body: "Nous collectons uniquement les informations nécessaires pour traiter votre commande et assurer la livraison, comme le nom, le téléphone et l'adresse." },
      { title: 'Utilisation des données', body: 'Vos données sont utilisées exclusivement pour traiter vos commandes et vous contacter à leur sujet. Elles ne sont pas partagées avec des tiers sans votre consentement.' },
      { title: 'Protection des données', body: 'Nous prenons les mesures techniques nécessaires pour protéger vos données contre tout accès ou utilisation non autorisés.' },
    ],
    termsTitle: 'Conditions générales',
    termsSections: [
      { title: 'Commandes', body: "La commande est confirmée après contact avec le client. Le magasin se réserve le droit d'annuler toute commande avec des informations incomplètes." },
      { title: 'Prix', body: 'Tous les prix affichés sont en monnaie locale et peuvent changer sans préavis.' },
      { title: 'Livraison', body: 'Les délais de livraison varient selon la wilaya. Les frais de livraison sont calculés séparément du prix du produit.' },
    ],
    cookiesTitle: 'Politique des cookies',
    cookiesSections: [
      { title: "Qu'est-ce que les cookies", body: "De petits fichiers stockés dans votre navigateur pour améliorer l'expérience de navigation et mémoriser le contenu de votre panier." },
      { title: 'Notre utilisation des cookies', body: 'Nous utilisons les cookies uniquement à des fins opérationnelles essentielles comme la sauvegarde du contenu du panier, sans suivi publicitaire.' },
      { title: 'Contrôle', body: 'Vous pouvez désactiver les cookies dans les paramètres de votre navigateur, sachant que cela peut affecter certaines fonctionnalités du magasin.' },
    ],
    contactTitle: 'Contactez-nous', contactName: 'Nom', contactEmail: 'Email',
    contactPhone: 'Téléphone', contactMessage: 'Message', contactSend: 'Envoyer',
    contactSending: 'Envoi en cours...', contactSent: 'Message envoyé ✓',
    contactSentDesc: 'Nous vous contacterons dans les plus brefs délais.', contactSendAnother: 'Envoyer un autre message',
  },
  en: {
    dir: 'ltr' as const,
    home: 'Home', contact: 'Contact', cart: 'Cart', menuLabel: 'Menu',
    search: 'Search products...', searching: 'Searching...', noResults: 'No results found', showAll: 'Show all results →',
    all: 'All', noProducts: 'No products available at the moment.', shopNow: 'Shop Now', cartBtn: 'My Cart',
    searchResultsFor: 'Results for:',
    fullName: 'Full Name', fullNamePh: 'Your full name', errName: 'Name is required',
    phone: 'Phone Number', phonePh: '0555 xx xx xx', errPhone: 'Phone number is required', errPhoneInvalid: 'Invalid phone number',
    wilaya: 'Wilaya', errWilaya: 'Select a wilaya', wilayaPh: 'Choose wilaya', wilayaNA: 'Delivery unavailable at the moment',
    ...
    orderInfo: 'Delivery information', addToCart: 'Add to Cart', addedMsg: 'Added to cart ✓',
    orderNow: 'Order Now', confirmOrder: 'Confirm Order', sending: 'Sending...', back: 'Cancel',
    errSubmit: 'An error occurred, please try again.', stockLabel: 'In stock',
    myCart: 'My Cart', cartEmpty: 'Your cart is empty', cartEmptyDesc: 'Start shopping now.',
    ...
    trust: [
      ...
      { t: 'Genuine Products',   s: 'Quality guaranteed' },
      { t: 'Tech Support',       s: 'Available 24/7' },
    ],
    privacyTitle: 'Privacy Policy',
    privacySections: [
      { title: 'Data Collection', body: 'We collect only the information necessary to process your order and ensure delivery, such as your name, phone number, and address.' },
      { title: 'Use of Data', body: 'Your data is used exclusively to process your orders and contact you about them. It is never shared with third parties without your consent.' },
      { title: 'Data Protection', body: 'We take the necessary technical measures to protect your data from unauthorized access or use.' },
    ],
    termsTitle: 'Terms & Conditions',
    termsSections: [
      { title: 'Orders', body: 'Orders are confirmed after contacting the customer. The store reserves the right to cancel any order with incomplete information.' },
      { title: 'Prices', body: 'All displayed prices are in local currency and may change without prior notice.' },
      { title: 'Delivery', body: 'Delivery times vary by wilaya. Shipping fees are calculated separately from the product price.' },
    ],
    cookiesTitle: 'Cookie Policy',
    cookiesSections: [
      { title: 'What are cookies', body: 'Small files stored in your browser to improve the browsing experience and remember the contents of your cart.' },
      { title: 'Our use of cookies', body: 'We use cookies only for essential operational purposes such as saving cart contents, with no advertising tracking.' },
      { title: 'Control', body: 'You can disable cookies in your browser settings, though this may affect some store features.' },
    ],
    contactTitle: 'Contact Us', contactName: 'Name', contactEmail: 'Email',
    contactPhone: 'Phone', contactMessage: 'Message', contactSend: 'Send',
    contactSending: 'Sending...', contactSent: 'Message sent ✓',
    contactSentDesc: 'We will get back to you as soon as possible.', contactSendAnother: 'Send another message',
  },
} as const;
...
export default function Main({ store, children, domain }: any) {
  ...
  return (
    <div dir={t.dir} style={{ background: BG, minHeight: '100vh', fontFamily: FONT_BODY }}>
      ...
      <header style={{
        ...
        <div className="sb-container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 72, gap: 16 }}>
          ...
          <nav className="sb-nav-links">
            <Link href="/" className="sb-nav-link" style={{ color: TXT, textDecoration: 'none', fontWeight: 600, fontSize: 14 }}>{t.home}</Link>
            <Link href="/contact" className="sb-nav-link" style={{ color: TXT, textDecoration: 'none', fontWeight: 600, fontSize: 14 }}>{t.contact}</Link>
          </nav>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                ...
                <div className="sb-search-dropdown" style={{ boxShadow: '0 20px 44px rgba(0,0,0,.5)' }}>
                  <div style={{ display: 'flex', borderBottom: `1px solid ${BD}` }}>
                    <input
                      ...
                      placeholder={t.search} style={{ ...({} as any), flex: 1, background: 'transparent', border: 'none', outline: 'none', color: TXT, padding: '12px 14px', fontFamily: 'inherit' }}
                    />
            ...
            {showCart && (
              <Link href="/cart" aria-label={t.cart} style={{
            ...
            <button className="sb-nav-burger" aria-label={t.menuLabel} onClick={() => setOpen(true)} style={{
              background: 'transparent', border: `1px solid ${BD}`, borderRadius: 2, width: 40, height: 40,
      ...
      <div className="sb-container" style={{ padding: '48px 1.5rem 24px', }}>
        <div className="sb-footer-grid">
          <div>
            ...
            <p style={{ color: SUB, fontSize: 12, marginTop: 16 }}>© {new Date().getFullYear()} {store?.name}. {t.rightsReserved}</p>
          </div>
          <div>
          ...
          <div>
            <div style={{ fontWeight: 700, fontSize: 13, color: TXT, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 16 }}>{t.contactSect}</div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
    ...
    <div dir={t.dir}>
      ...
      <section style={{ borderBottom: `1px solid ${BD}`, background: CARD }}>
        <div className="sb-container" style={{ display: 'grid', gridTemplateColumns: 'repeat(2,1fr)', gap: 20, padding: '28px 1.5rem' }}>
          {([Truck, Shield, Zap, Headset] as const).map((Icon, i) => (
            <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              <Icon size={22} color={A} />
              <div>
                <div style={{ fontWeight: 700, fontSize: 13 }}>{t.trust[i].t}</div>
                <div style={{ color: SUB, fontSize: 11.5 }}>{t.trust[i].s}</div>
              </div>
            </div>
          ))}
        </div>
      ...
      <section id="products" className="sb-container" style={{ padding: '32px 1.5rem 60px' }}>
        ...
        {products.length === 0 && (
          <div style={{ textAlign: 'center', padding: '80px 0', color: SUB }}>{t.noProducts}</div>
        )}
        ...
        <div>
          ...
          {product?.offers?.length > 0 && (
            <div style={{ marginBottom: 22 }}>
              <div style={{ fontWeight: 700, fontSize: 13, marginBottom: 10, textTransform: 'uppercase', letterSpacing: .5 }}>{t.offersTitle}</div>
          ...
          <ProductForm
            ...
            selectedVariants={selectedVariants} platform="web" store={store}
          />

          {product?.desc && (
            <div style={{ marginTop: 34, borderTop: `1px solid ${BD}`, paddingTop: 22 }}>
              <div style={{ fontWeight: 700, fontSize: 13, marginBottom: 10, textTransform: 'uppercase', letterSpacing: .5 }}>{t.descTitle}</div>
...
export function ProductForm({ product, userId, domain, selectedOffer, setSelectedOffer, selectedVariants, platform, store }: any) {
  ...
  const validate = () => {
    ...
    if (!/^(0|\+213)[5-7]\d{8}$/.test(fd.customerPhone)) errs.customerPhone = t.errPhoneInvalid;
  ...
  return (
    <div style={{ border: `1px solid ${BD}`, background: CARD, padding: 20 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 18 }}>
        ...
        <span style={{ color: SUB, fontSize: 12.5 }}>{product?.stock != null ? `${t.stockLabel}: ${product.stock}` : ''}</span>
      </div>
      ...
      {product?.store?.cart === true && (
        <button className="sb-btn-primary" onClick={addToCart} style={{ ...btnSecondaryStyle, width: '100%', marginBottom: 10 }}>
          {added ? t.addedMsg : t.addToCart}
        </button>
      )}
      {!isOrderNow && (
        <button className="sb-btn-primary" onClick={() => setIsOrderNow(true)} style={{ ...btnPrimaryStyle, width: '100%' }}>{t.orderNow}</button>
      )}

      {isOrderNow && (
        <div style={{ marginTop: 18, borderTop: `1px solid ${BD}`, paddingTop: 18 }}>
          <FormField label={t.fullName} error={errors.customerName}>
            <input className="sb-input" value={fd.customerName} onChange={(e) => setFd({ ...fd, customerName: e.target.value })} placeholder={t.fullNamePh} />
          </FormField>
          <FormField label={t.phone} error={errors.customerPhone}>
            <input className="sb-input" value={fd.customerPhone} onChange={(e) => setFd({ ...fd, customerPhone: e.target.value })} placeholder={t.phonePh} />
          </FormField>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 16 }}>
            {(['home', 'office'] as const).map((type) => (
              <button key={type} onClick={() => setFd({ ...fd, typeLivraison: type })} style={{
                minHeight: 44, border: `1px solid ${fd.typeLivraison === type ? A : BD}`, background: fd.typeLivraison === type ? AL : 'transparent',
                color: fd.typeLivraison === type ? A : TXT, fontWeight: 700, fontSize: 13, cursor: 'pointer',
              }}>{type === 'home' ? t.deliveryHome : t.deliveryOffice}</button>
            ))}
          </div>

          <div style={{ background: SURF, border: `1px solid ${BD}`, padding: 14, marginBottom: 16 }}>
            {[
              { l: t.price, v: `${fp.toLocaleString('fr-FR')} دج` },
              { l: t.qty, v: `× ${fd.quantity}` },
              { l: t.delivery, v: selW ? `${getLiv().toLocaleString('fr-FR')} دج` : '—' },
            ].map((row) => (
          ...
          <button onClick={() => setIsOrderNow(false)} disabled={submitting} style={{ ...btnSecondaryStyle, width: '100%' }}>{t.back}</button>
        </div>
      )}
    </div>
  );
...
export function Cart({ domain, store }: any) {
  ...
  if (success) {
    return (
      <div className="sb-container" style={{ padding: '90px 1.5rem', textAlign: 'center' }}>
        <h1 style={{ fontFamily: FONT_HEAD, fontWeight: 900, fontSize: 28, marginBottom: 12, color: A }}>{t.successTitle}</h1>
        <p style={{ color: SUB, marginBottom: 26 }}>{t.successDesc}</p>
        <Link href="/" style={{ ...btnPrimaryStyle, textDecoration: 'none', display: 'inline-flex' }}>{t.backToShop}</Link>
      </div>
    );
  }
  ...
  if (items.length === 0) {
    return (
      <div className="sb-container" style={{ padding: '90px 1.5rem', textAlign: 'center' }}>
        ...
        <h1 style={{ fontFamily: FONT_HEAD, fontWeight: 900, fontSize: 24, marginBottom: 10 }}>{t.cartEmpty}</h1>
        <Link href="/" style={{ ...btnPrimaryStyle, textDecoration: 'none', display: 'inline-flex' }}>{t.shopNow}</Link>
      </div>
    );
  }
  ...
  return (
    <div className="sb-container" style={{ padding: '40px 1.5rem 70px' }}>
      <h1 style={{ fontFamily: FONT_HEAD, fontWeight: 900, fontSize: 26, marginBottom: 26 }}>{t.myCart}</h1>
      <div className="sb-cart-inner">
            ...
            return (
              <div key={i} style={{ display: 'flex', gap: 14, border: `1px solid ${BD}`, background: CARD, padding: 12 }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <p style={{ color: SUB, fontSize: 12.5, margin: 0 }}>{t.qty}: {it.quantity}</p>
                </div>
        ...
        <div style={{ border: `1px solid ${BD}`, background: CARD, padding: 20, alignSelf: 'flex-start' }}>
          <h2 style={{ fontFamily: FONT_HEAD, fontWeight: 900, fontSize: 17, marginBottom: 16 }}>{t.orderInfo}</h2>
          <FormField label={t.fullName} error={errors.customerName}>
            <input className="sb-input" value={fd.customerName} onChange={(e) => setFd({ ...fd, customerName: e.target.value })} placeholder={t.fullNamePh} />
          </FormField>
          <FormField label={t.phone} error={errors.customerPhone}>
...
export function Privacy({ store }: any) {
  ...
  return (
    <Shell title={t.privacyTitle}>
      {t.privacySections.map((s, i) => <InfoBlock key={i} title={s.title} body={s.body} />)}
    </Shell>
  );
}
export function Terms({ store }: any) {
  ...
  return (
    <Shell title={t.termsTitle}>
      {t.termsSections.map((s, i) => <InfoBlock key={i} title={s.title} body={s.body} />)}
    </Shell>
  );
}
export function Cookies({ store }: any) {
  ...
  return (
    <Shell title={t.cookiesTitle}>
      {t.cookiesSections.map((s, i) => <InfoBlock key={i} title={s.title} body={s.body} />)}
    </Shell>
  );
}
...
export function Contact({ store }: any) {
  ...
  if (sent) {
    return (
      <div className="sb-container" style={{ padding: '90px 1.5rem', textAlign: 'center' }}>
        <h1 style={{ fontFamily: FONT_HEAD, fontWeight: 900, fontSize: 26, marginBottom: 12, color: A }}>{t.contactSent}</h1>
        <p style={{ color: SUB, marginBottom: 22 }}>{t.contactSentDesc}</p>
        <button className="sb-btn-primary" onClick={() => { setSent(false); setForm({ name: '', email: '', phone: '', message: '' }); }} style={btnSecondaryStyle}>{t.contactSendAnother}</button>
      </div>
    );
  }
  ...
  return (
    <div className="sb-container" style={{ padding: '50px 1.5rem 70px' }}>
      <h1 style={{ fontFamily: FONT_HEAD, fontWeight: 900, fontSize: 28, marginBottom: 30 }}>{t.contactTitle}</h1>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 32 }} className="sb-details-inner">
        ...
        <div>
          <FormField label={t.contactName}><input className="sb-input" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} /></FormField>
          <FormField label={t.contactEmail}><input className="sb-input" type="email" value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} /></FormField>
          <FormField label={t.contactPhone}><input className="sb-input" value={form.phone} onChange={(e) => setForm({ ...form, phone: e.target.value })} /></FormField>
          <FormField label={t.contactMessage}><textarea className="sb-input" rows={5} style={{ resize: 'none' }} value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })} /></FormField>
          <button className="sb-btn-primary" onClick={submit} disabled={submitting} style={{ ...btnPrimaryStyle, width: '100%' }}>{submitting ? t.contactSending : t.contactSend}</button>
        </div>
      </div>
    </div>
  );
